...
"""
    Standard PPO configuration as in cleanRL. Used for BaselineDDPG experiments.
"""

def net_cfg(space_descr: EnvSpaceDescription, layer_sizes: tuple[int] = (64,64), critic_sizes: tuple = (64,64), low_std_critic: bool = False, continuous: bool = True):
